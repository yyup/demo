...
public class RedisUtil {
     ...
     * @throws IOException 
     */
    private void initJedisPool() throws IOException {
        ...
        jedisPool = new JedisPool(config,redisIp,redisPort,1000*2,redisAuth);
    }
...
//===========================================================
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        String werwe = RedisUtil.getInstance().strings().set("werwe", params);
